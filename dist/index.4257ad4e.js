...
var c = 0;
(0, _gsapDefault.default).from(".loading__box", {
    duration: 1,
    opacity: 0,
    y: -100,
    ease: "bounce.out"
...
var barInterval = setInterval(function() {
    ...
    if (c == 101) {
        ...
        (0, _gsapDefault.default).to(".landing", {
            zIndex: 3
        });
        (0, _gsapDefault.default).from(".items", {
            delay: 3.5,
            duration: 3,
            opacity: 0,
            y: -100,
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["21l9L","9OMkf"], "9OMkf", "parcelRequire46e4")
